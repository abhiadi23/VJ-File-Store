...
# Bot Information
API_ID = int(environ.get("API_ID", "27322718"))
API_HASH = environ.get("API_HASH", "4f6d1b67cf101aea5cfO536885aa1b82")
BOT_TOKEN = environ.get("BOT_TOKEN", "")

PICS = (environ.get('PICS', 'https://graph.org/file/ce1723991756e48c35aa1.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6701907262').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "seishiroatfilesbrobot") # without @
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002637845907"))
